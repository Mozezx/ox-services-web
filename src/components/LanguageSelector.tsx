...
const LanguageSelector: React.FC<LanguageSelectorProps> = ({ isScrolled }) => {
    ...
    const languages: Language[] = ['en', 'nl', 'es', 'fr', 'pt'];
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors ${isScrolled ? 'text-primary dark:text-white' : 'text-white'}`}
