...
const Hero: React.FC<HeroProps> = ({ content }) => {
    ...
    const slides = [
        '/hero_images/slide1.webp',
        '/hero_images/slide2.webp',
        '/hero_images/slide3.webp',
        '/hero_images/slide4.webp',
        '/hero_images/slide5.webp',
        '/hero_images/slide6.webp',
        '/hero_images/slide7.webp'
    ];
