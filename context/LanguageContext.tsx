...
const translations: Record<Language, TextData> = {
    ...
    pt: {
        ...
        services: {
            ...
            items: [
                { id: 'joinery', title: 'Carpintaria e Vidros em Alumínio', description: 'Janelas e portas com desempenho térmico e durabilidade.', icon: 'window', imageUrl: '/aluminum-joinery.png', link: '/services/joinery.html' },
                { id: 'solar', title: 'Sistemas Solares Fotovoltaicos', description: 'Eficiência energética com soluções solares integradas.', icon: 'solar_power', imageUrl: 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80', link: '/services/solar.html' },
                ...
                { id: 'roofing', title: 'Coberturas em Membrana EPDM', description: 'Membrana EPDM industrial com barreira impermeável.', icon: 'roofing', imageUrl: '/epdm-roofing.png', link: '/services/roofing.html' },
            ],
        },
        portfolio: {
            ...
            projects: [
                ...
                { id: 'p4', title: 'Impermeabilização de Cobertura', category: 'EPDM', imageUrl: '/epdm-roofing.png' },
        ...
        cta: {
            heading: 'Pronto para Começar o Seu Projeto?',
            subHeading: 'Contacte a nossa equipa para uma consulta gratuita.',
            primaryAction: 'Contactar',
            secondaryAction: 'Ver Projetos',
        },
        contact: {
