...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: data.body,
    icon: data.icon || '/notification-icon.webp',
    badge: data.badge || '/notification-icon.webp',
    vibrate: [200, 100, 200],
    silent: false,
    ...
    actions: [
      { action: 'view', title: 'Ver agendamento', icon: '/notification-icon.webp' },
